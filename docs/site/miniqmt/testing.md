...
项目测试代码位于 [test/](https://github.com/weihong-su/miniQMT/tree/main/test) 目录，使用标准 `unittest`。当前回归配置见 `test/integration_test_config.json`，包含 36 个测试组（含 `fast` 快速子集）。

最近一次（2026-09-14, v3.9.2）使用 Anaconda `python39` 执行 `--all-with-fast` 实测：**36 组、148 模块、3166 用例、3166 通过、0 失败、0 错误、0 跳过，成功率 100%**。
